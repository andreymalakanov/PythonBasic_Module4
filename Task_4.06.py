...
sum_kostya = int(input('Введите значение, выпавшее Косте: '))
sum_owner = int(input('Введите значение, выпавшее Владельцу: '))
if sum_kostya >= sum_owner:
  debt_kostya = (sum_kostya - sum_owner) * 1000
  print('Костя платит', str(debt_kostya) + '$')
else:
  debt_owner = (sum_kostya + sum_owner) * 1000
  print('Владелец платит', str(debt_owner) + '$')
print('Игра окончена!')